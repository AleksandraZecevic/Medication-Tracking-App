...
export default function App() {
  ...
  // Fetch next user_id when switching to signup mode
  useEffect(() => {
    if (mode === "signup") {
      ...
      // Clear user_id when switching back to login
  ...
  const signUpForm = (
    <>
      <input
        ...
        onChange={handleChange}
        className="input"
        readOnly // Prevent manual editing to avoid conflicts, since we fetch nextId
      />
      <input
        type="text"
        name="name"
